...
var _user$project$Coins$hitted = function (coins) {
	return _elm_lang$core$List$length(
		A2(_elm_lang$core$List$filter, _user$project$Coin$isHit, coins));
};
var _user$project$Coins$sum = function (coins) {
	return _elm_lang$core$List$sum(
		A2(
			_elm_lang$core$List$map,
			_user$project$Coin$value,
			A2(_elm_lang$core$List$filter, _user$project$Coin$isHit, coins)));
};
