...
var _user$project$Coins$next = F2(
	function (seed, coins) {
		...
		var newValues = _elm_lang$core$Tuple$first(
...
var _user$project$Player$next = F2(
	function (value, player) {
		return function (player) {
			...
			_user$project$Player$resetHand(
...
var _user$project$Init$initCoins = {
	...
	_1: {
		...
		_0: _user$project$Coin$Entry(
			A2(_user$project$Coin$EntryCoin, 0, false)),
		_1: {
			ctor: '::',
			_0: _user$project$Coin$Entry(
				A2(_user$project$Coin$EntryCoin, 0, false)),
...
var _user$project$Init$randomSeedCmd = A2(
	_elm_lang$core$Random$generate,
	function (value) {
		return _user$project$Init$RecieveSeed(
			_elm_lang$core$Random$initialSeed(value));
	},
	A2(_elm_lang$core$Random$int, 0, 1000));
var _user$project$Init$init = {ctor: '_Tuple2', _0: _user$project$Init$initModel, _1: _user$project$Init$randomSeedCmd};
...
var _user$project$View$viewComboInfo = function (combo) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('combo info'),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$viewGameInfo = function (game) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('game info'),
			_1: {ctor: '[]'}
		});
};
