...
var _user$project$View$toComboInfo = function (model) {
	var _p1 = model.player.comboMultiple;
	var multipleValue = _p1._0;
	var multipleFactor = _p1._1;
	var _p2 = model.player.comboSum;
	var sumValue = _p2._0;
	var sumFactor = _p2._1;
	return A4(
...
var _user$project$View$toBoardInfo = function (model) {
	var coinsInfo = A2(
		...
		function (_p6) {
			var _p7 = _p6;
			return A2(_user$project$View$toCoinInfo, _p7._0, _p7._1);
		},
		A2(
