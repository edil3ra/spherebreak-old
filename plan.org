...
**** functions
	 ...
	 incrementsValue -> Coins -> Coins
	 incrementsCount -> Coins -> Coins
	 kills -> Coins -> Coins (kill border with number over x, put counter to 0)
	 revives -> Coins -> Coins (revive border with counter over x revive entries)
	 randomizes -> Coins -> Coins (randomize the core coin, randomize the the revive border when counter = 0)
	 next -> Coins -> Coins (incrementsValue incrementsCount, kills, revives, randomizes)
